...
const PROJECT_KEYWORDS: Record<string, string> = {
  artvizual: "artvizual-gym-fitness-qr",
  "branded qr": "artvizual-gym-fitness-qr",
  "fitness qr": "artvizual-gym-fitness-qr",
  "gym qr": "artvizual-gym-fitness-qr",
  gpass: "gpass-loyalty",
  "g pass": "gpass-loyalty",
  reloop: "reloop-cards",
  stempel: "reloop-cards",
  "stamp card": "reloop-cards",
  bluebird: "bluebird-evolv-rewards",
  evolv: "bluebird-evolv-rewards",
  gusto: "gusto-italian",
  franco: "franco-manca",
  ...
  fithq: "fithq",
  fit: "fithq",
  mysmart: "mysmartaccesscard",
  msac: "mysmartaccesscard",
  "smart access": "mysmartaccesscard",
  kartle: "kartle",
  egen: "egen-active",
  "egen active": "egen-active",
  kyga: "kyga-digital",
  mkm: "mkm-building-supplies",
  materials: "materials-market",
  ecommerce: "materials-market",
  "e-commerce": "mkm-building-supplies",
  loyalty: "kartle",
  wallet: "kartle",
